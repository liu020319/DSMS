...
public class PurchaseRecordController {
    ...
    public Result<List<Map<String, Object>>> monthlyStats(@RequestParam(required = false) Long userId) {
    ...
    public Result<List<Map<String, Object>>> yearlyStats(@RequestParam(required = false) Long userId) {
        return Result.success(purchaseRecordService.getYearlyStats(userId));
    }

    @GetMapping("/export")
    public void export(@RequestParam(required = false) Long userId, HttpServletResponse response) throws Exception {
